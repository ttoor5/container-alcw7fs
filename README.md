...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-alcw7fs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-alcw7fs.containers.anotherwebservice.com/
...
```
git clone git@github.com:ttoor5/container-alcw7fs.git
cd container-alcw7fs
```
...
```
docker attach container-alcw7fs
```
